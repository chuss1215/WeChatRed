...
@class WCRedEnvelopesLogicMgr; @class WCTableViewSectionManager; @class MMServiceCenter; @class CContactMgr; @class WCTableViewCellManager; @class CMessageMgr; @class WCBizUtil; @class NewSettingViewController; 
